...
const SellContainer = ({activeAccount,
                        ...
                        setDisplayState,
                        disabled} : Props) => {
  // console.debug("exchangeContext.tradeData.sellBalanceOf = " + exchangeContext.tradeData.sellBalanceOf)
  // exchangeContext.tradeData.sellBalanceOf = formatUnits(exchangeContext.tradeData.sellBalanceOf, exchangeContext.sellTokenContract.decimals);
...
//          Balance: {exchangeContext.tradeData.sellFormattedBalance}
          tradeData.Balance: {tradeData.sellFormattedBalance}
        </div>
        {IsSpCoin ?
          <>
