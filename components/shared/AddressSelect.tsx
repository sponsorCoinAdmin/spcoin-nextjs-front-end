...
export default function AddressSelect() {
  const {
    ...
    validHexInput,
    debouncedHexInput,
    dumpSharedPanelContext,    // ← newly added
  ...
  // Dump on every keystroke
  useEffect(() => {
    console.log('⏳ raw input changed:', validHexInput);
    dumpSharedPanelContext();
  }, [validHexInput, dumpSharedPanelContext]);

  // Dump again when the debounce “settles”
  useEffect(() => {
    console.log('✅ debouncedHexInput settled:', debouncedHexInput);
    dumpSharedPanelContext();
  }, [debouncedHexInput, dumpSharedPanelContext]);
