...
export default function ManageAccountsPanel() {
  ...
  const handleEdit = (account: SpCoinWalletAccount) => {
    router.push(`/EditAccount?account=${encodeURIComponent(account.address)}`);
  };
  ...
  return (
    <PanelGate panel={SP_COIN_DISPLAY.MANAGE_ACCOUNTS_PANEL}>
