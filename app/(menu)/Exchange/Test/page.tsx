...
const USDT_POLYGON_CONTRACT:Address|undefined  = '0xc2132D05D31c914a87C6611C10748AEb04B58e8F'
const CHKN_ETHEREUM_CONTRACT:Address|undefined = '0xD55210Bb6898C021a19de1F58d27b71f095921Ee'
...
const USDT_ETHEREUM_CONTRACT:Address|undefined = NULL_CONTRACT //undefined //'0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48'

function App() {
  ACTIVE_ACCOUNT = useAccount()
  const [ ACTIVE_ACCOUNT_ADDRESS, setActiveAccountAddress ] = useState<Address|undefined>(BURN_ADDRESS)
  const [ TOKEN_CONTRACT_ADDRESS, setDefaultTokenContractAddress ] = useState<Address|undefined>(BURN_ADDRESS)
