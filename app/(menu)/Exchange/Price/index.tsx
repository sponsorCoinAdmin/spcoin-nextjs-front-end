...
export default function PriceView() {
  ...
  const [transactionType, setTransactionType] = useState<TRADE_DIRECTION>(tradeData.transactionType);
  ...
  useEffect(() => {
    ...
    if (transactionType === TRADE_DIRECTION.SELL_EXACT_OUT) {
      setBuyAmount(sellAmount);
    } else if (transactionType === TRADE_DIRECTION.BUY_EXACT_IN) {
