...
export const addRecipientRateTransaction = async (context, _recipientKey, _recipientRateKey, _transactionQty) => {
    context.spCoinLogger.logFunctionHeader(
        "addRecipientTransaction = async(" + _recipientKey + ", " + _recipientRateKey + ", " + _transactionQty + ")"
    );
