// @ts-nocheck
export const addBackDatedAgentRateTransaction = async (context, _adminSigner, _sponsorKey, _recipientKey, _recipientRateKey, _accountAgentKey, _agentRateKey, _transactionQty, _transactionBackDate) => {
    context.spCoinLogger.logFunctionHeader("addBackDatedAgentRateTransaction = async(" +
        _adminSigner + ", " +
        _sponsorKey + ", " +
        _recipientKey + ", " +
        _recipientRateKey + ", " +
    ...
    const addTx = await context.addAgentRateTransaction(
        _sponsorKey,
        _recipientKey,
        _recipientRateKey,
        _accountAgentKey,
