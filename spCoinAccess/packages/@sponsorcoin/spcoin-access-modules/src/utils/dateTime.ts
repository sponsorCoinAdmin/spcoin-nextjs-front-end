...
export const year = day * 365.242199; // Actual time in year considering leap year
export const month = year / 12;
export const millennium = year * 1000;
...
export const bigIntToDecString = (_value) => { return bigIntToString(_value, 10); };
export const bigIntToHexString = (_value) => { return bigIntToString(_value, 16); };
