...
export class SpCoinSerialize {
    ...
    getAgentRateRecordFields: (
        _sponsorKey: string,
        _recipientKey: string,
        _recipientRateKey: SerializedValue,
        _agentKey: string,
        _agentRateKey: SerializedValue
    ) => Promise<string[]>;
    ...
    constructor(_spCoinContractDeployed) {
        ...
        this.getSerializedRecipientRateList = async (_sponsorKey, _recipientKey, _recipientRateKey) =>
            this.getRecipientRateRecordFields(_sponsorKey, _recipientKey, _recipientRateKey);
        this.getSerializedRecipientRecordList = async (_sponsorKey, _recipientKey) =>
            this.getRecipientRecordFields(_sponsorKey, _recipientKey);
        this.getSerializedAgentRateList = async (_sponsorKey, _recipientKey, _recipientRateKey, _agentKey, _agentRateKey) =>
            this.getAgentRateRecordFields(_sponsorKey, _recipientKey, _recipientRateKey, _agentKey, _agentRateKey);
