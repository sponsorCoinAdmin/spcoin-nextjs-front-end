...
const HH_FORK_CHAIN_ID = ASSET_MAP[31337] ? 31337 : (Number(Object.keys(ASSET_MAP)[0]) || 31337);
const HH_FORK_TOKEN_ASSET_CHAIN_ID = ASSET_MAP[HH_FORK_CHAIN_ID] || HH_FORK_CHAIN_ID;
