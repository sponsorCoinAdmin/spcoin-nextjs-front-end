...
const RADIO_ALIAS: Partial<Record<SP_COIN_DISPLAY, SP_COIN_DISPLAY>> = {
  ...
  [SP_COIN_DISPLAY.RECIPIENT_LIST_SELECT_PANEL_OLD]: SP_COIN_DISPLAY.RECIPIENT_LIST_SELECT_PANEL_OLD,
  [SP_COIN_DISPLAY.AGIENT_LIST_SELECT_PANEL_OLD]: SP_COIN_DISPLAY.AGIENT_LIST_SELECT_PANEL_OLD,
};
