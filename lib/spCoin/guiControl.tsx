...
const spCoinDisplayString = (spCoinDisplay: SP_COIN_DISPLAY | undefined): string => {
  switch (spCoinDisplay) {
    case SP_COIN_DISPLAY.SHOW_TRADING_STATION_PANEL:
      return `spCoinDisplay(${SP_COIN_DISPLAY.SHOW_TRADING_STATION_PANEL}) = UNDEFINED`;
    ...
    case SP_COIN_DISPLAY.SHOW_RECIPIENT_SELECT_PANEL:
      return `spCoinDisplay(${SP_COIN_DISPLAY.SHOW_RECIPIENT_SELECT_PANEL}) = SHOW_RECIPIENT_SELECT_PANEL`;
    ...
    case SP_COIN_DISPLAY.SHOW_SPONSOR_RATE_CONFIG_PANEL:
      return `spCoinDisplay(${SP_COIN_DISPLAY.SHOW_SPONSOR_RATE_CONFIG_PANEL}) = SHOW_SPONSOR_RATE_CONFIG_PANEL`;
    default:
